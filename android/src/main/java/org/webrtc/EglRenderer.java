...
public class EglRenderer implements VideoSink {
    ...
    public void init(@Nullable Context sharedContext, int[] configAttributes, GlDrawer drawer, boolean usePresentationTimeStamp) {
        synchronized(this.handlerLock) {
            if (this.renderThreadHandler != null) {
                ...
                renderThread.start();
                this.renderThreadHandler = new EglRenderer.HandlerWithExceptionCallback(renderThread.getLooper(), new Runnable() {
                    public void run() {
                        synchronized(EglRenderer.this.handlerLock) {
    ...
    public void init(@Nullable Context sharedContext, int[] configAttributes, GlDrawer drawer) {
    ...
    public void addFrameListener(EglRenderer.FrameListener listener, float scale, @Nullable GlDrawer drawerParam, boolean applyFpsReduction) {
    ...
    private void renderFrameOnRenderThread() {
        ...
        if (this.eglBase != null && this.eglBase.hasSurface()) {
            ...
            } catch (GlOutOfMemoryException var25) {
    ...
    private void logStatistics() {
        ...
        synchronized(this.statisticsLock) {
            ...
            if (elapsedTimeNs > 0L && (this.minRenderPeriodNs != 9223372036854775807L || this.framesReceived != 0)) {
