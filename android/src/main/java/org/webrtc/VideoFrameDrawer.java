...
public class VideoFrameDrawer {
    ...
    public static void drawTexture(GlDrawer drawer, TextureBuffer buffer, Matrix renderMatrix, int frameWidth, int frameHeight, int viewportX, int viewportY, int viewportWidth, int viewportHeight) {
    ...
    public void drawFrame(VideoFrame frame, GlDrawer drawer, Matrix additionalRenderMatrix) {
        this.drawFrame(frame, drawer, additionalRenderMatrix, 0, 0, frame.getRotatedWidth(), frame.getRotatedHeight());
    }

    public void drawFrame(VideoFrame frame, GlDrawer drawer, @Nullable Matrix additionalRenderMatrix, int viewportX, int viewportY, int viewportWidth, int viewportHeight) {
        ...
        if (this.renderWidth > 0 && this.renderHeight > 0) {
            boolean isTextureFrame = frame.getBuffer() instanceof TextureBuffer;
            ...
            if (isTextureFrame) {
                ...
                drawTexture(drawer, (TextureBuffer) frame.getBuffer(), this.renderMatrix, this.renderWidth, this.renderHeight, viewportX, viewportY, viewportWidth, viewportHeight);
            } else {
    ...
    public Buffer prepareBufferForViewportSize(Buffer buffer, int width, int height) {
        buffer.retain();
        return buffer;
    }
    ...
    private static class YuvUploader {
        ...
        @Nullable
        public int[] uploadFromBuffer(I420Buffer buffer) {
