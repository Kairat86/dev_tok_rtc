...
public class ScreenCapturerAndroid implements VideoCapturer, VideoSink {
    ...
    public synchronized void stopCapture() {
        this.checkNotDisposed();
        ThreadUtils.invokeAtFrontUninterruptedly(this.surfaceTextureHelper.getHandler(), new Runnable() {
            public void run() {
    ...
    public synchronized void changeCaptureFormat(int width, int height, int ignoredFramerate) {
        ...
        if (this.virtualDisplay != null) {
            ThreadUtils.invokeAtFrontUninterruptedly(this.surfaceTextureHelper.getHandler(), () -> {
                ScreenCapturerAndroid.this.virtualDisplay.release();
